classdef FourChannelScrambler
    methods(Static)
        function [v0_hat, v1_hat, v2_hat, v3_hat] = scramble(v0, v1, v2, v3, frame_number, group_id)
            ...
            v0_hat = SingleChannelScrambler.scramble(v0, key_0);
            v1_hat = SingleChannelScrambler.scramble(v1, key_1);
            v2_hat = SingleChannelScrambler.scramble(v2, key_2);
            v3_hat = SingleChannelScrambler.scramble(v3, key_3);
        end
    end
end